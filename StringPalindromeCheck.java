//TO CHECK WHETHER STRING IS  PALINDROME OR NOT USING STRING FUNCTIONS
...
public class StringPalindromeCheck {
    ...
    public boolean isPalindrome(String str) {
        ...
        if (l.equals(f)) {
            ...
            // reducing the number of characters by 2 for the next recursion
    ...
    public static void main(String argvs[]) {
        // instantiating the class palindromeCheck
        StringPalindromeCheck obj = new StringPalindromeCheck();
        String str[] = {
                "madam",
                "rock",
                "eye",
